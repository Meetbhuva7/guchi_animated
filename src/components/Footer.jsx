...
function Footer() {
    return (
        <div className="w-full h-screen bg-zinc-900 text-white flex gap-5 p-20">
            <div className="w-1/2 flex flex-col justify-between font-['Founders_Grotesk_X'] ">
                <div className="heading  px-[4vw] uppercase">
                ...
                <h3><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-1/2 font-['Founders_Grotesk_X'] ">
                <div className="heading  px-[4vw] uppercase">
                    <h1 className="text-[8vw] font-semibold  leading-none -mb-10">Presentations</h1>
                    <div className="dets font-['Neue_Montreal_Regular'] mt-10">
